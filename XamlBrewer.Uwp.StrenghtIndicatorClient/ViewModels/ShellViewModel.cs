...
using Mvvm.Services;
using XamlBrewer.Uwp.StrengthIndicatorClient;
...
namespace Mvvm
{
    internal class ShellViewModel : ViewModelBase
    {
        ...
        {
            // Build the menus
            Menu.Add(new MenuItem() { Glyph = Icon.GetIcon("HomeIcon"), Text = "Main", NavigationDestination = typeof(XamlBrewer.Uwp.StrengthIndicatorClient.MainPage) });
